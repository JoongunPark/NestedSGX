...
void* SGX_UBRIDGE(SGX_NOCONVENTION, dmalloc_test, (size_t i));
void* SGX_UBRIDGE(SGX_NOCONVENTION, dmalloc, (size_t i));
void SGX_UBRIDGE(SGX_NOCONVENTION, dfree, (void* i));
